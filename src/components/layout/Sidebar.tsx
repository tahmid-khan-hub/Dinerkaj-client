    ...
    return (
        <aside className="w-44 min-w-56 flex flex-col gap-8 px-3 py-6 bg-(--bg-surface) border-r border-white/5">
            <div className="flex flex-col">
                <span className="font-serif text-(--text-primary) text-2xl font-bold ">Dinerkaj</span>
                <span className="text-[11px] mt-1.5 text-(--text-muted)">Your daily task & focus companion</span>
            </div>
